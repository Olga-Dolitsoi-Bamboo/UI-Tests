...
class TestClassClient:
    def test_add_client(self, my_app):
        ...
        with allure.step("Go to Clients page"):
            menu_page.go_to_option(st.CLIENTS_TEXT)
        with allure.step("Go to create client Popup"):
            create_client = client_page.go_to_create_clients()
        with allure.step("Create client with following parameters"):
        ...
        with allure.step("Go to created clients and check results"):
    ...
    def test_edit_client(self, my_app):
        ...
        with allure.step("Edit clients info"):
        ...
        with allure.step("Check if changes applied successfully"):
    ...
    def test_negative_create_client(self, my_app):
        ...
        with allure.step("Go to create client Popup"):
            create_client = client_page.go_to_create_clients()
        with allure.step("Create client with incorrect client name, exchange rate and empty integration type"):
